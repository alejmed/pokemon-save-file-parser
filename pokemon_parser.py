...
MOVE_NAMES: Dict[int, str] = {
    ...
    150: "High Jump Kick", 151: "Glare", 152: "Dream Eater",
    153: "Poison Gas", 154: "Barrage", 155: "Leech Life",
    156: "Lovely Kiss", 157: "Sky Attack", 158: "Transform",
    159: "Bubble", 160: "Dizzy Punch", 161: "Spore", 162: "Flash",
    163: "Psywave", 164: "Splash", 165: "Acid Armor",
    166: "Crabhammer", 167: "Explosion", 168: "Fury Swipes",
    ...
    217: "Endure", 218: "Charm", 219: "Rollout", 220: "False Swipe",
    221: "Swagger", 222: "Milk Drink", 223: "Spark", 224: "Fury Cutter",
    225: "Steel Wing", 226: "Mean Look", 227: "Attract", 228: "Sleep Talk",
    229: "Heal Bell", 230: "Return", 231: "Present", 232: "Frustration",
    233: "Safeguard", 234: "Pain Split", 235: "Sacred Fire",
    ...
    254: "Crunch", 255: "Mirror Coat", 256: "Psych Up", 257: "Extreme Speed",
    258: "Ancient Power", 259: "Shadow Ball", 260: "Future Sight",
    261: "Rock Smash", 262: "Whirlpool", 263: "Beat Up", 264: "Fake Out",
    265: "Uproar", 266: "Stockpile", 267: "Spit Up", 268: "Swallow",
    269: "Heat Wave", 270: "Hail", 271: "Torment", 272: "Flatter",
    273: "Will-O-Wisp", 274: "Facade", 275: "Focus Punch", 276: "Smelling Salts",
    277: "Follow Me", 278: "Nature Power", 279: "Charge", 280: "Taunt",
    281: "Helping Hand", 282: "Trick", 283: "Role Play", 284: "Wish",
    285: "Assist", 286: "Ingrain", 287: "Superpower", 288: "Magic Coat",
    289: "Recycle", 290: "Brick Break", 291: "Yawn", 292: "Knock Off",
    293: "Endeavor", 294: "Eruption", 295: "Skill Swap", 296: "Imprison",
    297: "Refresh", 298: "Grudge", 299: "Snatch", 300: "Secret Power",
    301: "Dive", 302: "Arm Thrust", 303: "Camouflage", 304: "Tail Glow",
    305: "Luster Purge", 306: "Mist Ball", 307: "Feather Dance", 308: "Teeter Dance",
    309: "Blaze Kick", 310: "Mud Sport", 311: "Ice Ball", 312: "Needle Arm",
    313: "Slack Off", 314: "Hyper Voice", 315: "Poison Fang", 316: "Crush Claw",
    317: "Blast Burn", 318: "Hydro Cannon", 319: "Meteor Mash", 320: "Astonish",
    ...
    329: "Metal Sound", 330: "Grass Whistle", 331: "Tickle", 332: "Cosmic Power",
    333: "Water Spout", 334: "Signal Beam", 335: "Shadow Punch", 336: "Extrasensory",
    337: "Sky Uppercut", 338: "Sand Tomb", 339: "Sheer Cold", 340: "Muddy Water",
    341: "Bullet Seed", 342: "Aerial Ace", 343: "Icicle Spear", 344: "Iron Defense",
    345: "Block", 346: "Howl", 347: "Dragon Claw", 348: "Frenzy Plant",
    349: "Bulk Up", 350: "Bounce", 351: "Mud Shot", 352: "Poison Tail",
    353: "Covet", 354: "Volt Tackle",
}
...
def write_u16(data: bytearray, offset: int, value: int) -> None:
    """Write unsigned 16-bit little-endian value at offset."""
    data[offset:offset+2] = struct.pack('<H', value)


def write_u32(data: bytearray, offset: int, value: int) -> None:
    """Write unsigned 32-bit little-endian value at offset."""
...
def get_species_name(species_id: int) -> str:
    ...
    Args:
        species_id: Internal species ID (0-412)

    Returns:
        Species name or "Unknown #<id>" if not found
    """
...
def get_move_name(move_id: int) -> str:
    ...
    Args:
        move_id: Move ID (0-354)

    Returns:
        Move name or "Move #<id>" if not found
    """
...
def get_nature(personality: int) -> str:
    ...
    Returns:
        Nature name (one of 25 possible natures)
    """
...
def decrypt_array3(data: bytearray) -> bytes:
    ...
    decrypted_blocks = [
        ...
        data[ENCRYPTED_DATA_START+24:ENCRYPTED_DATA_START+36],
        data[ENCRYPTED_DATA_START+36:ENCRYPTED_DATA_START+48]
    ]

    unshuffled_blocks = [bytearray(12) for _ in range(4)]
    for i, block_idx in enumerate(shuffle_order):
        unshuffled_blocks[i] = decrypted_blocks[block_idx]
    ...
    data[ENCRYPTED_DATA_START+24:ENCRYPTED_DATA_START+36] = unshuffled_blocks[2]
    data[ENCRYPTED_DATA_START+36:ENCRYPTED_DATA_START+48] = unshuffled_blocks[3]
...
def find_section(save_data: bytes, section_id: int) -> Optional[bytes]:
    ...
    Searches both save blocks (A and B) for the specified section ID,
...
def display_pokemon(pokemon: Dict, index: int) -> None:
    ...
    print(f"  Ability Bit: {pokemon['ivs']['ability_bit']}")
